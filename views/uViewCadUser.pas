...
begin
 ShowMessage('Vá para o gerenciamento da sua conta google, clique em Segurança,'+
 ' depois faça a verificação em duas etapas, depois de feito isso clique em senhas'+
 ' de app e gere uma nova senha. Copie e cole essa senha no campo de senha de endereço de email');
end;
