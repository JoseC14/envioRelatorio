...
begin
  ...
  begin
      ...
      'INNER JOIN tb_user ON tb_historico.idusuario = tb_user.id   ORDER BY datahoraenvio DESC');
      Open;
  end;
  cbFilNome.ItemIndex := -1;
  cbOrgao.ItemIndex   := -1;
...
begin
  ...
  begin
    ...
    'tb_historico.tipo,tb_historico.dataenvio,tb_user.usuario FROM tb_historico '+
    'INNER JOIN tb_user ON tb_historico.idusuario = tb_user.id '+
    'ORDER BY tb_historico.datahoraenvio DESC');
