object frmGerEmail: TfrmGerEmail
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmGerEmail'
  ...
  object btnLimpaFiltro: TbsSkinSpeedButton
    Left = 540
    Top = 438
    Width = 121
    Height = 19
  ...
  object sqlConsulta: TFDQuery
    ...
    SQL.Strings = (
      'SELECT tb_mails.id, tb_cidade.nome, tb_mails.orgao, '
      'tb_mails.email FROM tb_mails INNER JOIN tb_cidade ON '
      'tb_cidade.id = tb_mails.idcidade ORDER BY tb_cidade.'
      'nome')
    Left = 736
    Top = 328
    object sqlConsultaid: TIntegerField
      FieldName = 'id'
    end
    object sqlConsultanome: TWideStringField
      FieldName = 'nome'
      Size = 255
    end
    object sqlConsultaorgao: TWideStringField
      FieldName = 'orgao'
      Size = 255
    end
    object sqlConsultaemail: TWideStringField
      FieldName = 'email'
      Size = 255
    end
  end
